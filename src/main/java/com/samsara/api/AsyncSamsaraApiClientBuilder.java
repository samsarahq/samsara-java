...
public class AsyncSamsaraApiClientBuilder {
    ...
    private String token = System.getenv("SAMSARA_API_KEY");

    private Environment environment = Environment.PRODUCTION_API;

    private OkHttpClient httpClient;

    /**
     * Sets token.
     * Defaults to the SAMSARA_API_KEY environment variable.
     */
    public AsyncSamsaraApiClientBuilder token(String token) {
        this.token = token;
        return this;
    }

    public AsyncSamsaraApiClientBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public AsyncSamsaraApiClientBuilder url(String url) {
     ...
     */
    public AsyncSamsaraApiClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncSamsaraApiClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncSamsaraApiClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncSamsaraApiClientBuilder addHeader(String name, String value) {
    ...
    public AsyncSamsaraApiClient build() {
        if (token == null) {
            throw new RuntimeException("Please provide token or set the SAMSARA_API_KEY environment variable.");
        }
        validateConfiguration();
        return new AsyncSamsaraApiClient(buildClientOptions());
    }
}

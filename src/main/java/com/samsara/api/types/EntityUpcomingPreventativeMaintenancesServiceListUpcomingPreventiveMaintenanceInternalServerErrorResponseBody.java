...
@JsonDeserialize(
        builder =
                EntityUpcomingPreventativeMaintenancesServiceListUpcomingPreventiveMaintenanceInternalServerErrorResponseBody
                        .Builder.class)
public final
class EntityUpcomingPreventativeMaintenancesServiceListUpcomingPreventiveMaintenanceInternalServerErrorResponseBody {
    ...
    public static final class Builder implements MessageStage, RequestIdStage, _FinalStage {
        ...
        EntityUpcomingPreventativeMaintenancesServiceListUpcomingPreventiveMaintenanceInternalServerErrorResponseBody
                build() {
            return new EntityUpcomingPreventativeMaintenancesServiceListUpcomingPreventiveMaintenanceInternalServerErrorResponseBody(

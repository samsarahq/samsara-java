...
@JsonDeserialize(builder = AlertObjectDriverResponseBody.Builder.class)
public final class AlertObjectDriverResponseBody {
    ...
    private AlertObjectDriverResponseBody(
    ...
    /**
     * @return The list of <a href="https://kb.samsara.com/hc/en-us/articles/360026674631-Using-Tags-and-Tag-Nesting">tags</a> associated with the driver.
     */
    @JsonProperty("tags")
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AlertObjectDriverResponseBody && equalTo((AlertObjectDriverResponseBody) other);
    }
    ...
    private boolean equalTo(AlertObjectDriverResponseBody other) {
    ...
    public interface IdStage {
        ...
        Builder from(AlertObjectDriverResponseBody other);
    }

    public interface _FinalStage {
        AlertObjectDriverResponseBody build();
        ...
        /**
         * <p>The list of <a href="https://kb.samsara.com/hc/en-us/articles/360026674631-Using-Tags-and-Tag-Nesting">tags</a> associated with the driver.</p>
         */
    ...
    public static final class Builder implements IdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(AlertObjectDriverResponseBody other) {
        ...
        @java.lang.Override
        public AlertObjectDriverResponseBody build() {
            return new AlertObjectDriverResponseBody(attributes, externalIds, id, name, tags, additionalProperties);
        }
    }
}

...
@JsonDeserialize(builder = EquipmentFuelPercent.Builder.class)
public final class EquipmentFuelPercent {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EquipmentFuelPercent && equalTo((EquipmentFuelPercent) other);
    }
    ...
    private boolean equalTo(EquipmentFuelPercent other) {
    ...
    public interface TimeStage {
        ...
        Builder from(EquipmentFuelPercent other);
    }
    ...
    public static final class Builder implements TimeStage, ValueStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(EquipmentFuelPercent other) {
            time(other.getTime());
        ...
        @java.lang.Override
        public EquipmentFuelPercent build() {
            return new EquipmentFuelPercent(time, value, additionalProperties);
        }
    }
}

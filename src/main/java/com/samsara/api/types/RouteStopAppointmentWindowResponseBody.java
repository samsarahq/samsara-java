...
@JsonDeserialize(builder = RouteStopAppointmentWindowResponseBody.Builder.class)
public final class RouteStopAppointmentWindowResponseBody {
    ...
    private RouteStopAppointmentWindowResponseBody(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof RouteStopAppointmentWindowResponseBody
                && equalTo((RouteStopAppointmentWindowResponseBody) other);
    }
    ...
    private boolean equalTo(RouteStopAppointmentWindowResponseBody other) {
    ...
    public interface EndTimeStage {
        ...
        Builder from(RouteStopAppointmentWindowResponseBody other);
    }
    ...
    public interface _FinalStage {
        RouteStopAppointmentWindowResponseBody build();
    }
    ...
    public static final class Builder implements EndTimeStage, StartTimeStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(RouteStopAppointmentWindowResponseBody other) {
        ...
        @java.lang.Override
        public RouteStopAppointmentWindowResponseBody build() {
            return new RouteStopAppointmentWindowResponseBody(endTime, startTime, additionalProperties);
        }
    }
}

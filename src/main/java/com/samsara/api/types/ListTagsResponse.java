...
@JsonDeserialize(builder = ListTagsResponse.Builder.class)
public final class ListTagsResponse {
    private final Optional<List<Tag>> data;
    ...
    @JsonProperty("data")
    public Optional<List<Tag>> getData() {
        return data;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListTagsResponse && equalTo((ListTagsResponse) other);
    }
    ...
    private boolean equalTo(ListTagsResponse other) {
    ...
    public static final class Builder {
        private Optional<List<Tag>> data = Optional.empty();
        ...
        public Builder from(ListTagsResponse other) {
            data(other.getData());
        ...
        public Builder data(Optional<List<Tag>> data) {
            this.data = data;
            return this;
        }
        ...
        public ListTagsResponse build() {
            return new ListTagsResponse(data, pagination, additionalProperties);
        }
    }
}

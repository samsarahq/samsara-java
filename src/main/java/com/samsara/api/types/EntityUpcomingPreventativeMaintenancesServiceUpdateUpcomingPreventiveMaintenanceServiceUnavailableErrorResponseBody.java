...
@JsonDeserialize(
        builder =
                EntityUpcomingPreventativeMaintenancesServiceUpdateUpcomingPreventiveMaintenanceServiceUnavailableErrorResponseBody
                        .Builder.class)
public final
class EntityUpcomingPreventativeMaintenancesServiceUpdateUpcomingPreventiveMaintenanceServiceUnavailableErrorResponseBody {
    ...
    public static final class Builder implements MessageStage, RequestIdStage, _FinalStage {
        ...
        EntityUpcomingPreventativeMaintenancesServiceUpdateUpcomingPreventiveMaintenanceServiceUnavailableErrorResponseBody
                build() {
            return new EntityUpcomingPreventativeMaintenancesServiceUpdateUpcomingPreventiveMaintenanceServiceUnavailableErrorResponseBody(

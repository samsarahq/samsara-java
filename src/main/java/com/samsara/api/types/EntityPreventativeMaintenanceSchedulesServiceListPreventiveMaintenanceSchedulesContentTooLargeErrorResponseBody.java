...
@JsonDeserialize(
        builder =
                EntityPreventativeMaintenanceSchedulesServiceListPreventiveMaintenanceSchedulesContentTooLargeErrorResponseBody
                        .Builder.class)
public final
class EntityPreventativeMaintenanceSchedulesServiceListPreventiveMaintenanceSchedulesContentTooLargeErrorResponseBody {
    ...
    public static final class Builder implements MessageStage, RequestIdStage, _FinalStage {
        ...
        EntityPreventativeMaintenanceSchedulesServiceListPreventiveMaintenanceSchedulesContentTooLargeErrorResponseBody
                build() {
            return new EntityPreventativeMaintenanceSchedulesServiceListPreventiveMaintenanceSchedulesContentTooLargeErrorResponseBody(

...
@JsonDeserialize(
        builder =
                EntityUpcomingPreventativeMaintenancesServiceUpdateUpcomingPreventiveMaintenanceTooManyRequestsErrorResponseBody
                        .Builder.class)
public final
class EntityUpcomingPreventativeMaintenancesServiceUpdateUpcomingPreventiveMaintenanceTooManyRequestsErrorResponseBody {
    ...
    public static final class Builder implements MessageStage, RequestIdStage, _FinalStage {
        ...
        EntityUpcomingPreventativeMaintenancesServiceUpdateUpcomingPreventiveMaintenanceTooManyRequestsErrorResponseBody
                build() {
            return new EntityUpcomingPreventativeMaintenancesServiceUpdateUpcomingPreventiveMaintenanceTooManyRequestsErrorResponseBody(

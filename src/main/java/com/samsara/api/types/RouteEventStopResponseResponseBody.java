...
@JsonDeserialize(builder = RouteEventStopResponseResponseBody.Builder.class)
public final class RouteEventStopResponseResponseBody {
    ...
    private RouteEventStopResponseResponseBody(
    ...
    /**
     * @return ID of the stop this event belongs to.
     */
    @JsonProperty("id")
    public String getId() {
        return id;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof RouteEventStopResponseResponseBody
                && equalTo((RouteEventStopResponseResponseBody) other);
    }
    ...
    private boolean equalTo(RouteEventStopResponseResponseBody other) {
    ...
    public interface IdStage {
        /**
         * <p>ID of the stop this event belongs to.</p>
         */
        _FinalStage id(@NotNull String id);

        Builder from(RouteEventStopResponseResponseBody other);
    }

    public interface _FinalStage {
        RouteEventStopResponseResponseBody build();
    ...
    public static final class Builder implements IdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(RouteEventStopResponseResponseBody other) {
        ...
        @java.lang.Override
        public RouteEventStopResponseResponseBody build() {
            return new RouteEventStopResponseResponseBody(externalIds, id, additionalProperties);
        }
    }
}

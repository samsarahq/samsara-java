...
public final class RoutesFetchRouteResponseBody {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof RoutesFetchRouteResponseBody && equalTo((RoutesFetchRouteResponseBody) other);
    }
    ...
    private boolean equalTo(RoutesFetchRouteResponseBody other) {
    ...
    public static final class Builder {
        ...
        public Builder from(RoutesFetchRouteResponseBody other) {
            data(other.getData());
            return this;
        }
        ...
        public RoutesFetchRouteResponseBody build() {
            return new RoutesFetchRouteResponseBody(data, additionalProperties);
        }
    }
}

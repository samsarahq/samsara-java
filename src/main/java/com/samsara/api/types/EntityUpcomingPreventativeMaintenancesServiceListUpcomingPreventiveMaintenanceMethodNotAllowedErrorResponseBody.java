...
@JsonDeserialize(
        builder =
                EntityUpcomingPreventativeMaintenancesServiceListUpcomingPreventiveMaintenanceMethodNotAllowedErrorResponseBody
                        .Builder.class)
public final
class EntityUpcomingPreventativeMaintenancesServiceListUpcomingPreventiveMaintenanceMethodNotAllowedErrorResponseBody {
    ...
    public static final class Builder implements MessageStage, RequestIdStage, _FinalStage {
        ...
        EntityUpcomingPreventativeMaintenancesServiceListUpcomingPreventiveMaintenanceMethodNotAllowedErrorResponseBody
                build() {
            return new EntityUpcomingPreventativeMaintenancesServiceListUpcomingPreventiveMaintenanceMethodNotAllowedErrorResponseBody(

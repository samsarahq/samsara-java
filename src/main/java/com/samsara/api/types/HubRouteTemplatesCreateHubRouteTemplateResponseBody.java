...
public final class HubRouteTemplatesCreateHubRouteTemplateResponseBody {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof HubRouteTemplatesCreateHubRouteTemplateResponseBody
                && equalTo((HubRouteTemplatesCreateHubRouteTemplateResponseBody) other);
    }
    ...
    private boolean equalTo(HubRouteTemplatesCreateHubRouteTemplateResponseBody other) {
    ...
    public interface _FinalStage {
        HubRouteTemplatesCreateHubRouteTemplateResponseBody build();
    }
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(HubRouteTemplatesCreateHubRouteTemplateResponseBody other) {
            data(other.getData());
            return this;
        }
        ...
        @java.lang.Override
        public HubRouteTemplatesCreateHubRouteTemplateResponseBody build() {
            return new HubRouteTemplatesCreateHubRouteTemplateResponseBody(data, additionalProperties);
        }
    }
}

...
public final class DeviceRecoveryRecoverAssetResponseBody {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DeviceRecoveryRecoverAssetResponseBody
                && equalTo((DeviceRecoveryRecoverAssetResponseBody) other);
    }
    ...
    private boolean equalTo(DeviceRecoveryRecoverAssetResponseBody other) {
    ...
    public interface _FinalStage {
        DeviceRecoveryRecoverAssetResponseBody build();
    }
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(DeviceRecoveryRecoverAssetResponseBody other) {
            data(other.getData());
            return this;
        }
        ...
        @java.lang.Override
        public DeviceRecoveryRecoverAssetResponseBody build() {
            return new DeviceRecoveryRecoverAssetResponseBody(data, additionalProperties);
        }
    }
}

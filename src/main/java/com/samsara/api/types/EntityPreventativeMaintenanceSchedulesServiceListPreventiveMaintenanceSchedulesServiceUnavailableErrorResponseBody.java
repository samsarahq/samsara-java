...
@JsonDeserialize(
        builder =
                EntityPreventativeMaintenanceSchedulesServiceListPreventiveMaintenanceSchedulesServiceUnavailableErrorResponseBody
                        .Builder.class)
public final
class EntityPreventativeMaintenanceSchedulesServiceListPreventiveMaintenanceSchedulesServiceUnavailableErrorResponseBody {
    ...
    public static final class Builder implements MessageStage, RequestIdStage, _FinalStage {
        ...
        EntityPreventativeMaintenanceSchedulesServiceListPreventiveMaintenanceSchedulesServiceUnavailableErrorResponseBody
                build() {
            return new EntityPreventativeMaintenanceSchedulesServiceListPreventiveMaintenanceSchedulesServiceUnavailableErrorResponseBody(

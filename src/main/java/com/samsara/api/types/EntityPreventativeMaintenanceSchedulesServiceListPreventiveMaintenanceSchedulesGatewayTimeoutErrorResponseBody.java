...
@JsonDeserialize(
        builder =
                EntityPreventativeMaintenanceSchedulesServiceListPreventiveMaintenanceSchedulesGatewayTimeoutErrorResponseBody
                        .Builder.class)
public final
class EntityPreventativeMaintenanceSchedulesServiceListPreventiveMaintenanceSchedulesGatewayTimeoutErrorResponseBody {
    ...
    public static final class Builder implements MessageStage, RequestIdStage, _FinalStage {
        ...
        EntityPreventativeMaintenanceSchedulesServiceListPreventiveMaintenanceSchedulesGatewayTimeoutErrorResponseBody
                build() {
            return new EntityPreventativeMaintenanceSchedulesServiceListPreventiveMaintenanceSchedulesGatewayTimeoutErrorResponseBody(

...
@JsonDeserialize(builder = RouteEventRouteResponseResponseBody.Builder.class)
public final class RouteEventRouteResponseResponseBody {
    ...
    private RouteEventRouteResponseResponseBody(
    ...
    /**
     * @return ID of the route this event belongs to.
     */
    @JsonProperty("id")
    public String getId() {
        return id;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof RouteEventRouteResponseResponseBody
                && equalTo((RouteEventRouteResponseResponseBody) other);
    }
    ...
    private boolean equalTo(RouteEventRouteResponseResponseBody other) {
    ...
    public interface IdStage {
        /**
         * <p>ID of the route this event belongs to.</p>
         */
        _FinalStage id(@NotNull String id);

        Builder from(RouteEventRouteResponseResponseBody other);
    }

    public interface _FinalStage {
        RouteEventRouteResponseResponseBody build();
    ...
    public static final class Builder implements IdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(RouteEventRouteResponseResponseBody other) {
        ...
        @java.lang.Override
        public RouteEventRouteResponseResponseBody build() {
            return new RouteEventRouteResponseResponseBody(externalIds, id, additionalProperties);
        }
    }
}

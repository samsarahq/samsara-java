...
@JsonDeserialize(builder = EquipmentGatewayJ1939EngineSeconds.Builder.class)
public final class EquipmentGatewayJ1939EngineSeconds {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EquipmentGatewayJ1939EngineSeconds
                && equalTo((EquipmentGatewayJ1939EngineSeconds) other);
    }
    ...
    private boolean equalTo(EquipmentGatewayJ1939EngineSeconds other) {
    ...
    public interface TimeStage {
        ...
        Builder from(EquipmentGatewayJ1939EngineSeconds other);
    }
    ...
    public interface _FinalStage {
        EquipmentGatewayJ1939EngineSeconds build();
    }
    ...
    public static final class Builder implements TimeStage, ValueStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(EquipmentGatewayJ1939EngineSeconds other) {
            time(other.getTime());
        ...
        @java.lang.Override
        public EquipmentGatewayJ1939EngineSeconds build() {
            return new EquipmentGatewayJ1939EngineSeconds(time, value, additionalProperties);
        }
    }
}

...
@JsonDeserialize(
        builder =
                EntityUpcomingPreventativeMaintenancesServiceUpdateUpcomingPreventiveMaintenanceNotImplementedErrorResponseBody
                        .Builder.class)
public final
class EntityUpcomingPreventativeMaintenancesServiceUpdateUpcomingPreventiveMaintenanceNotImplementedErrorResponseBody {
    ...
    public static final class Builder implements MessageStage, RequestIdStage, _FinalStage {
        ...
        EntityUpcomingPreventativeMaintenancesServiceUpdateUpcomingPreventiveMaintenanceNotImplementedErrorResponseBody
                build() {
            return new EntityUpcomingPreventativeMaintenancesServiceUpdateUpcomingPreventiveMaintenanceNotImplementedErrorResponseBody(

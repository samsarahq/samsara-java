...
@JsonDeserialize(
        builder =
                ReplaceWarrantyAssetAssignmentsActionServiceReplaceWarrantyAssetAssignmentsMethodNotAllowedErrorResponseBody
                        .Builder.class)
public final
class ReplaceWarrantyAssetAssignmentsActionServiceReplaceWarrantyAssetAssignmentsMethodNotAllowedErrorResponseBody {
    ...
    public static final class Builder implements MessageStage, RequestIdStage, _FinalStage {
        ...
        ReplaceWarrantyAssetAssignmentsActionServiceReplaceWarrantyAssetAssignmentsMethodNotAllowedErrorResponseBody
                build() {
            return new ReplaceWarrantyAssetAssignmentsActionServiceReplaceWarrantyAssetAssignmentsMethodNotAllowedErrorResponseBody(

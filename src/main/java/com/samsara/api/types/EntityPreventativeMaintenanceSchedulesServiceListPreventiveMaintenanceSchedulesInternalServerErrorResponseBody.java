...
@JsonDeserialize(
        builder =
                EntityPreventativeMaintenanceSchedulesServiceListPreventiveMaintenanceSchedulesInternalServerErrorResponseBody
                        .Builder.class)
public final
class EntityPreventativeMaintenanceSchedulesServiceListPreventiveMaintenanceSchedulesInternalServerErrorResponseBody {
    ...
    public static final class Builder implements MessageStage, RequestIdStage, _FinalStage {
        ...
        EntityPreventativeMaintenanceSchedulesServiceListPreventiveMaintenanceSchedulesInternalServerErrorResponseBody
                build() {
            return new EntityPreventativeMaintenanceSchedulesServiceListPreventiveMaintenanceSchedulesInternalServerErrorResponseBody(

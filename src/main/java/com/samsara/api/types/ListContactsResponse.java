...
@JsonDeserialize(builder = ListContactsResponse.Builder.class)
public final class ListContactsResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListContactsResponse && equalTo((ListContactsResponse) other);
    }
    ...
    private boolean equalTo(ListContactsResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListContactsResponse other) {
            data(other.getData());
        ...
        public ListContactsResponse build() {
            return new ListContactsResponse(data, pagination, additionalProperties);
        }
    }
}

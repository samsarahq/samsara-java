...
public final class DeviceRecoveryMarkAssetMissingResponseBody {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DeviceRecoveryMarkAssetMissingResponseBody
                && equalTo((DeviceRecoveryMarkAssetMissingResponseBody) other);
    }
    ...
    private boolean equalTo(DeviceRecoveryMarkAssetMissingResponseBody other) {
    ...
    public interface _FinalStage {
        DeviceRecoveryMarkAssetMissingResponseBody build();
    }
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(DeviceRecoveryMarkAssetMissingResponseBody other) {
            data(other.getData());
            return this;
        }
        ...
        @java.lang.Override
        public DeviceRecoveryMarkAssetMissingResponseBody build() {
            return new DeviceRecoveryMarkAssetMissingResponseBody(data, additionalProperties);
        }
    }
}

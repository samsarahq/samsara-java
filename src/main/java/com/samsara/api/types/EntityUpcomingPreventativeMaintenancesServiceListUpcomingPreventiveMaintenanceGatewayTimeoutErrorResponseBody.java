...
@JsonDeserialize(
        builder =
                EntityUpcomingPreventativeMaintenancesServiceListUpcomingPreventiveMaintenanceGatewayTimeoutErrorResponseBody
                        .Builder.class)
public final
class EntityUpcomingPreventativeMaintenancesServiceListUpcomingPreventiveMaintenanceGatewayTimeoutErrorResponseBody {
    ...
    public static final class Builder implements MessageStage, RequestIdStage, _FinalStage {
        ...
        EntityUpcomingPreventativeMaintenancesServiceListUpcomingPreventiveMaintenanceGatewayTimeoutErrorResponseBody
                build() {
            return new EntityUpcomingPreventativeMaintenancesServiceListUpcomingPreventiveMaintenanceGatewayTimeoutErrorResponseBody(

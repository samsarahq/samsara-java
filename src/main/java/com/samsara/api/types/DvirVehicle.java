...
@JsonDeserialize(builder = DvirVehicle.Builder.class)
public final class DvirVehicle implements IVehicleTinyResponse {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DvirVehicle && equalTo((DvirVehicle) other);
    }
    ...
    private boolean equalTo(DvirVehicle other) {
    ...
    public static final class Builder {
        ...
        public Builder from(DvirVehicle other) {
        ...
        public DvirVehicle build() {
            return new DvirVehicle(externalIds, id, name, additionalProperties);
        }
    }
}

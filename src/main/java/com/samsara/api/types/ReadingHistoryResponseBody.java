...
@JsonDeserialize(builder = ReadingHistoryResponseBody.Builder.class)
public final class ReadingHistoryResponseBody {
    ...
    private ReadingHistoryResponseBody(
            String entityId,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ReadingHistoryResponseBody && equalTo((ReadingHistoryResponseBody) other);
    }
    ...
    private boolean equalTo(ReadingHistoryResponseBody other) {
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.entityId, this.externalIds, this.happenedAtTime, this.value);
    }
    ...
    public interface EntityIdStage {
        ...
        Builder from(ReadingHistoryResponseBody other);
    }

    public interface _FinalStage {
        ReadingHistoryResponseBody build();
    ...
    public static final class Builder implements EntityIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ReadingHistoryResponseBody other) {
        ...
        @java.lang.Override
        public ReadingHistoryResponseBody build() {
            return new ReadingHistoryResponseBody(entityId, externalIds, happenedAtTime, value, additionalProperties);
        }
    }
}

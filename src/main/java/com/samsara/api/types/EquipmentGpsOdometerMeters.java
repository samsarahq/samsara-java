...
@JsonDeserialize(builder = EquipmentGpsOdometerMeters.Builder.class)
public final class EquipmentGpsOdometerMeters {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EquipmentGpsOdometerMeters && equalTo((EquipmentGpsOdometerMeters) other);
    }
    ...
    private boolean equalTo(EquipmentGpsOdometerMeters other) {
    ...
    public interface TimeStage {
        ...
        Builder from(EquipmentGpsOdometerMeters other);
    }
    ...
    public interface _FinalStage {
        EquipmentGpsOdometerMeters build();
    }
    ...
    public static final class Builder implements TimeStage, ValueStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(EquipmentGpsOdometerMeters other) {
            time(other.getTime());
        ...
        @java.lang.Override
        public EquipmentGpsOdometerMeters build() {
            return new EquipmentGpsOdometerMeters(time, value, additionalProperties);
        }
    }
}

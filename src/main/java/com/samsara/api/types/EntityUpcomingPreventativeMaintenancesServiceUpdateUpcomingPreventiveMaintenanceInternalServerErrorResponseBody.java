...
@JsonDeserialize(
        builder =
                EntityUpcomingPreventativeMaintenancesServiceUpdateUpcomingPreventiveMaintenanceInternalServerErrorResponseBody
                        .Builder.class)
public final
class EntityUpcomingPreventativeMaintenancesServiceUpdateUpcomingPreventiveMaintenanceInternalServerErrorResponseBody {
    ...
    public static final class Builder implements MessageStage, RequestIdStage, _FinalStage {
        ...
        EntityUpcomingPreventativeMaintenancesServiceUpdateUpcomingPreventiveMaintenanceInternalServerErrorResponseBody
                build() {
            return new EntityUpcomingPreventativeMaintenancesServiceUpdateUpcomingPreventiveMaintenanceInternalServerErrorResponseBody(

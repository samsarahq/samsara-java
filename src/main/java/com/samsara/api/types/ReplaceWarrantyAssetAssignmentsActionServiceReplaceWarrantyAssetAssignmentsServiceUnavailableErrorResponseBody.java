...
@JsonDeserialize(
        builder =
                ReplaceWarrantyAssetAssignmentsActionServiceReplaceWarrantyAssetAssignmentsServiceUnavailableErrorResponseBody
                        .Builder.class)
public final
class ReplaceWarrantyAssetAssignmentsActionServiceReplaceWarrantyAssetAssignmentsServiceUnavailableErrorResponseBody {
    ...
    public static final class Builder implements MessageStage, RequestIdStage, _FinalStage {
        ...
        ReplaceWarrantyAssetAssignmentsActionServiceReplaceWarrantyAssetAssignmentsServiceUnavailableErrorResponseBody
                build() {
            return new ReplaceWarrantyAssetAssignmentsActionServiceReplaceWarrantyAssetAssignmentsServiceUnavailableErrorResponseBody(

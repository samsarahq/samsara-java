...
@JsonDeserialize(
        builder =
                EntityUpcomingPreventativeMaintenancesServiceUpdateUpcomingPreventiveMaintenanceContentTooLargeErrorResponseBody
                        .Builder.class)
public final
class EntityUpcomingPreventativeMaintenancesServiceUpdateUpcomingPreventiveMaintenanceContentTooLargeErrorResponseBody {
    ...
    public static final class Builder implements MessageStage, RequestIdStage, _FinalStage {
        ...
        EntityUpcomingPreventativeMaintenancesServiceUpdateUpcomingPreventiveMaintenanceContentTooLargeErrorResponseBody
                build() {
            return new EntityUpcomingPreventativeMaintenancesServiceUpdateUpcomingPreventiveMaintenanceContentTooLargeErrorResponseBody(

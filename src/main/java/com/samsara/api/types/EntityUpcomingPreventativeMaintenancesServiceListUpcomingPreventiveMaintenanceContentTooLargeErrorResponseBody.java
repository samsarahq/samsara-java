...
@JsonDeserialize(
        builder =
                EntityUpcomingPreventativeMaintenancesServiceListUpcomingPreventiveMaintenanceContentTooLargeErrorResponseBody
                        .Builder.class)
public final
class EntityUpcomingPreventativeMaintenancesServiceListUpcomingPreventiveMaintenanceContentTooLargeErrorResponseBody {
    ...
    public static final class Builder implements MessageStage, RequestIdStage, _FinalStage {
        ...
        EntityUpcomingPreventativeMaintenancesServiceListUpcomingPreventiveMaintenanceContentTooLargeErrorResponseBody
                build() {
            return new EntityUpcomingPreventativeMaintenancesServiceListUpcomingPreventiveMaintenanceContentTooLargeErrorResponseBody(

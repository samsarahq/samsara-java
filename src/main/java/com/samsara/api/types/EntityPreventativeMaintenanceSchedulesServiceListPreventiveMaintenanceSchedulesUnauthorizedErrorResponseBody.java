...
@JsonDeserialize(
        builder =
                EntityPreventativeMaintenanceSchedulesServiceListPreventiveMaintenanceSchedulesUnauthorizedErrorResponseBody
                        .Builder.class)
public final
class EntityPreventativeMaintenanceSchedulesServiceListPreventiveMaintenanceSchedulesUnauthorizedErrorResponseBody {
    ...
    public static final class Builder implements MessageStage, RequestIdStage, _FinalStage {
        ...
        EntityPreventativeMaintenanceSchedulesServiceListPreventiveMaintenanceSchedulesUnauthorizedErrorResponseBody
                build() {
            return new EntityPreventativeMaintenanceSchedulesServiceListPreventiveMaintenanceSchedulesUnauthorizedErrorResponseBody(

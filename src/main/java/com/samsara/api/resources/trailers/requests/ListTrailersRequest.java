...
@JsonDeserialize(builder = ListTrailersRequest.Builder.class)
public final class ListTrailersRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListTrailersRequest && equalTo((ListTrailersRequest) other);
    }
    ...
    private boolean equalTo(ListTrailersRequest other) {
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.tagIds, this.parentTagIds, this.limit, this.after);
    }
    ...
    public static final class Builder {
        ...
        public Builder from(ListTrailersRequest other) {
        ...
        public ListTrailersRequest build() {
            return new ListTrailersRequest(tagIds, parentTagIds, limit, after, additionalProperties);
        }
    }
}

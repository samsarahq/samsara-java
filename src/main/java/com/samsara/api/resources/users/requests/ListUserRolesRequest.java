...
@JsonDeserialize(builder = ListUserRolesRequest.Builder.class)
public final class ListUserRolesRequest {
    ...
    private ListUserRolesRequest(
            Optional<Long> limit, Optional<String> after, Map<String, Object> additionalProperties) {
        this.limit = limit;
        this.after = after;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListUserRolesRequest && equalTo((ListUserRolesRequest) other);
    }
    ...
    private boolean equalTo(ListUserRolesRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListUserRolesRequest other) {
        ...
        public ListUserRolesRequest build() {
            return new ListUserRolesRequest(limit, after, additionalProperties);
        }
    }
}

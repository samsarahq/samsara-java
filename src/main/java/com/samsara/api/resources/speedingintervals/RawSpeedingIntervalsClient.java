...
public class RawSpeedingIntervalsClient {
    protected final ClientOptions clientOptions;

    public RawSpeedingIntervalsClient(ClientOptions clientOptions) {
     ...
     */
    public SamsaraApiHttpResponse<SpeedingIntervalsGetSpeedingIntervalsResponseBody> getSpeedingIntervals(

...
public class AsyncVehicleLocationsClient {
     ...
     * <p>To use this endpoint, select <strong>Read Vehicle Statistics</strong> under the Vehicles category when creating or editing an API token. <a href="/docs/authentication#scopes-for-api-tokens">Learn More.</a></p>
     */
    public CompletableFuture<VehicleLocationsResponse> getVehicleLocations(RequestOptions requestOptions) {
        return this.rawClient.getVehicleLocations(requestOptions).thenApply(response -> response.body());
    }
     ...
     * <p>To use this endpoint, select <strong>Read Vehicle Statistics</strong> under the Vehicle category when creating or editing an API token. <a href="/docs/authentication#scopes-for-api-tokens">Learn More.</a></p>
     */
    public CompletableFuture<VehicleLocationsListResponse> getVehicleLocationsFeed(RequestOptions requestOptions) {
        return this.rawClient.getVehicleLocationsFeed(requestOptions).thenApply(response -> response.body());
    }

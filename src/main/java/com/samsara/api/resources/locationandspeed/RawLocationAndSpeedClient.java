...
public class RawLocationAndSpeedClient {
    protected final ClientOptions clientOptions;

    public RawLocationAndSpeedClient(ClientOptions clientOptions) {
     ...
     */
    public SamsaraApiHttpResponse<LocationAndSpeedGetLocationAndSpeedResponseBody> getLocationAndSpeed() {

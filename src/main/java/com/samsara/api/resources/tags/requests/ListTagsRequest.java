...
public final class ListTagsRequest {
    ...
    private ListTagsRequest(Optional<Long> limit, Optional<String> after, Map<String, Object> additionalProperties) {
        this.limit = limit;
        this.after = after;
    ...
    public static final class Builder {
        ...
        public ListTagsRequest build() {
            return new ListTagsRequest(limit, after, additionalProperties);
        }
    }
}

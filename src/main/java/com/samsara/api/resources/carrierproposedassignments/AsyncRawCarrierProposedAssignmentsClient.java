...
public class AsyncRawCarrierProposedAssignmentsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawCarrierProposedAssignmentsClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<SamsaraApiHttpResponse<ListCarrierProposedAssignmentResponse>>
     ...
     */
    public CompletableFuture<SamsaraApiHttpResponse<ListCarrierProposedAssignmentResponse>>
            listCarrierProposedAssignments(RequestOptions requestOptions) {
        return listCarrierProposedAssignments(
     ...
     */
    public CompletableFuture<SamsaraApiHttpResponse<ListCarrierProposedAssignmentResponse>>
            listCarrierProposedAssignments(ListCarrierProposedAssignmentsRequest request) {
    ...
    public CompletableFuture<SamsaraApiHttpResponse<ListCarrierProposedAssignmentResponse>>
        ...
        if (request.getActiveTime().isPresent()) {
            QueryStringMapper.addQueryParameter(
                    httpUrl, "activeTime", request.getActiveTime().get(), false);
        }
        ...
        CompletableFuture<SamsaraApiHttpResponse<ListCarrierProposedAssignmentResponse>> future =
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SamsaraApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, ListCarrierProposedAssignmentResponse.class),
                                response));
                        return;
                    }
     ...
     */
    public CompletableFuture<SamsaraApiHttpResponse<CarrierProposedAssignmentResponse>> createCarrierProposedAssignment(
            CreateCarrierProposedAssignmentRequest request) {
        return createCarrierProposedAssignment(request, null);
    }
    ...
    public CompletableFuture<SamsaraApiHttpResponse<CarrierProposedAssignmentResponse>> createCarrierProposedAssignment(
        ...
        CompletableFuture<SamsaraApiHttpResponse<CarrierProposedAssignmentResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SamsaraApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, CarrierProposedAssignmentResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     * <p>To use this endpoint, select <strong>Write Carrier-Proposed Assignments</strong> under the Assignments category when creating or editing an API token. &lt;a href=&quot;https://developers.samsara.com/docs/authentication#scopes-for-api-tokens&quot; target=&quot;_blank&quot;&gt;Learn More.&lt;/a&gt;</p>
     */
    public CompletableFuture<SamsaraApiHttpResponse<String>> deleteCarrierProposedAssignment(String id) {
     ...
     * <p>To use this endpoint, select <strong>Write Carrier-Proposed Assignments</strong> under the Assignments category when creating or editing an API token. &lt;a href=&quot;https://developers.samsara.com/docs/authentication#scopes-for-api-tokens&quot; target=&quot;_blank&quot;&gt;Learn More.&lt;/a&gt;</p>
     */
    public CompletableFuture<SamsaraApiHttpResponse<String>> deleteCarrierProposedAssignment(
    ...
    public CompletableFuture<SamsaraApiHttpResponse<String>> deleteCarrierProposedAssignment(
        ...
        return deleteCarrierProposedAssignment(id, request, null);
    }

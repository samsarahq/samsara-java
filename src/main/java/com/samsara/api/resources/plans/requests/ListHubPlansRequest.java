...
@JsonDeserialize(builder = ListHubPlansRequest.Builder.class)
public final class ListHubPlansRequest {
    ...
    /**
     * @return Comma-separated list of plan IDs for filtering.
     */
    ...
    /**
     * @return Time filter of when the plan was updated, in RFC 3339 format
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListHubPlansRequest && equalTo((ListHubPlansRequest) other);
    }
    ...
    private boolean equalTo(ListHubPlansRequest other) {
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.hubId, this.planIds, this.startTime, this.endTime, this.after, this.limit);
    }
    ...
    public interface HubIdStage {
        ...
        Builder from(ListHubPlansRequest other);
    }

    public interface _FinalStage {
        ListHubPlansRequest build();

        /**
         * <p>Comma-separated list of plan IDs for filtering.</p>
         */
        _FinalStage planIds(Optional<String> planIds);

        _FinalStage planIds(String planIds);

        /**
         * <p>Time filter of when the plan was updated, in RFC 3339 format</p>
         */
    ...
    public static final class Builder implements HubIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ListHubPlansRequest other) {
        ...
        public _FinalStage planIds(Optional<String> planIds) {
            this.planIds = planIds;
            return this;
        }

        @java.lang.Override
        public ListHubPlansRequest build() {
            return new ListHubPlansRequest(hubId, planIds, startTime, endTime, after, limit, additionalProperties);
        }
    }
}

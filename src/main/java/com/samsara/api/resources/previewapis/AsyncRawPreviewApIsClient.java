...
public class AsyncRawPreviewApIsClient {
     ...
     */
    public CompletableFuture<
                    SamsaraApiHttpResponse<FleetInstallerPhotoUploadsPostFleetInstallerPhotoUploadResponseBody>>
    ...
    public CompletableFuture<
        ...
        CompletableFuture<SamsaraApiHttpResponse<FleetInstallerPhotoUploadsPostFleetInstallerPhotoUploadResponseBody>>
                future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
     ...
     */
    public CompletableFuture<
                    SamsaraApiHttpResponse<FleetInstallerPhotoUploadsPostFleetInstallerPhotoUploadCompleteResponseBody>>

...
public class AsyncRawPreviewApIsClient {
     ...
     * <p><strong>Submit Feedback</strong>: Likes, dislikes, and API feature requests should be filed as feedback in our <a href="https://forms.gle/zkD4NCH7HjKb7mm69" target="_blank">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href="https://www.samsara.com/help" target="_blank">submit a case</a> to our support team.</p>
     */
    public CompletableFuture<SamsaraApiHttpResponse<EntityPurchaseOrdersServiceListPurchaseOrdersResponseBody>>
            listPurchaseOrders(ListPurchaseOrdersRequest request) {
     ...
     */
    public CompletableFuture<SamsaraApiHttpResponse<EntityPurchaseOrdersServiceListPurchaseOrdersResponseBody>>
            listPurchaseOrders(ListPurchaseOrdersRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("preview/maintenance/purchase-orders");
        ...
        CompletableFuture<SamsaraApiHttpResponse<EntityPurchaseOrdersServiceListPurchaseOrdersResponseBody>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SamsaraApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString,
                                        EntityPurchaseOrdersServiceListPurchaseOrdersResponseBody.class),
                                response));
                        return;
                    }
                    try {
     ...
     * <p><strong>Submit Feedback</strong>: Likes, dislikes, and API feature requests should be filed as feedback in our <a href="https://forms.gle/zkD4NCH7HjKb7mm69" target="_blank">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href="https://www.samsara.com/help" target="_blank">submit a case</a> to our support team.</p>
     */
    public CompletableFuture<SamsaraApiHttpResponse<EntityPurchaseOrdersServiceCreatePurchaseOrderResponseBody>>
            createPurchaseOrder(EntityPurchaseOrdersServiceCreatePurchaseOrderRequestBody request) {
    ...
    public CompletableFuture<SamsaraApiHttpResponse<EntityPurchaseOrdersServiceCreatePurchaseOrderResponseBody>>
        ...
        CompletableFuture<SamsaraApiHttpResponse<EntityPurchaseOrdersServiceCreatePurchaseOrderResponseBody>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SamsaraApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString,
                                        EntityPurchaseOrdersServiceCreatePurchaseOrderResponseBody.class),
                                response));
                        return;
                    }
                    try {
     ...
     * <p><strong>Submit Feedback</strong>: Likes, dislikes, and API feature requests should be filed as feedback in our <a href="https://forms.gle/zkD4NCH7HjKb7mm69" target="_blank">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href="https://www.samsara.com/help" target="_blank">submit a case</a> to our support team.</p>
     */
    public CompletableFuture<SamsaraApiHttpResponse<Void>> deletePurchaseOrder(DeletePurchaseOrderRequest request) {
     ...
     * <p><strong>Submit Feedback</strong>: Likes, dislikes, and API feature requests should be filed as feedback in our <a href="https://forms.gle/zkD4NCH7HjKb7mm69" target="_blank">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href="https://www.samsara.com/help" target="_blank">submit a case</a> to our support team.</p>
     */
    public CompletableFuture<SamsaraApiHttpResponse<Void>> deletePurchaseOrder(
     ...
     * <p><strong>Submit Feedback</strong>: Likes, dislikes, and API feature requests should be filed as feedback in our <a href="https://forms.gle/zkD4NCH7HjKb7mm69" target="_blank">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href="https://www.samsara.com/help" target="_blank">submit a case</a> to our support team.</p>
     */
    public CompletableFuture<SamsaraApiHttpResponse<EntityPurchaseOrdersServiceUpdatePurchaseOrderResponseBody>>
            updatePurchaseOrder(EntityPurchaseOrdersServiceUpdatePurchaseOrderRequestBody request) {
    ...
    public CompletableFuture<SamsaraApiHttpResponse<EntityPurchaseOrdersServiceUpdatePurchaseOrderResponseBody>>
        ...
        CompletableFuture<SamsaraApiHttpResponse<EntityPurchaseOrdersServiceUpdatePurchaseOrderResponseBody>> future =
                new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SamsaraApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString,
                                        EntityPurchaseOrdersServiceUpdatePurchaseOrderResponseBody.class),
                                response));
                        return;
                    }
                    try {

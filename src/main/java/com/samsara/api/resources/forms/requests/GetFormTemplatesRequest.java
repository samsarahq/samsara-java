...
@JsonDeserialize(builder = GetFormTemplatesRequest.Builder.class)
public final class GetFormTemplatesRequest {
    ...
    private GetFormTemplatesRequest(
    ...
    /**
     * @return A comma-separated list containing up to 100 template IDs to filter on.
     */
    @JsonProperty("ids")
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetFormTemplatesRequest && equalTo((GetFormTemplatesRequest) other);
    }
    ...
    private boolean equalTo(GetFormTemplatesRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetFormTemplatesRequest other) {
            ids(other.getIds());
        ...
        /**
         * <p>A comma-separated list containing up to 100 template IDs to filter on.</p>
         */
        ...
        public GetFormTemplatesRequest build() {
            return new GetFormTemplatesRequest(ids, after, additionalProperties);
        }
    }
}

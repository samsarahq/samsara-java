...
public class AsyncRawIssuesClient {
     ...
     * <p><strong>Submit Feedback</strong>: Likes, dislikes, and API feature requests should be filed as feedback in our <a href="https://forms.gle/zkD4NCH7HjKb7mm69" target="_blank">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href="https://www.samsara.com/help" target="_blank">submit a case</a> to our support team.</p>
     */
    public CompletableFuture<SamsaraApiHttpResponse<IssuesPostIssueResponseBody>> postIssue(
            IssuesPostIssueRequestBody request) {
        return postIssue(request, null);
    }
    ...
    public CompletableFuture<SamsaraApiHttpResponse<IssuesPostIssueResponseBody>> postIssue(
        ...
        CompletableFuture<SamsaraApiHttpResponse<IssuesPostIssueResponseBody>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SamsaraApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, IssuesPostIssueResponseBody.class),
                                response));
                        return;
                    }
                    try {

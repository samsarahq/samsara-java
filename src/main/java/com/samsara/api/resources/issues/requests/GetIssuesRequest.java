...
@JsonDeserialize(builder = GetIssuesRequest.Builder.class)
public final class GetIssuesRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetIssuesRequest && equalTo((GetIssuesRequest) other);
    }
    ...
    private boolean equalTo(GetIssuesRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetIssuesRequest other) {
            ids(other.getIds());
        ...
        public GetIssuesRequest build() {
            return new GetIssuesRequest(ids, include, additionalProperties);
        }
    }
}

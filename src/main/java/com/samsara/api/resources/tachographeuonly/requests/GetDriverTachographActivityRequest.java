...
@JsonDeserialize(builder = GetDriverTachographActivityRequest.Builder.class)
public final class GetDriverTachographActivityRequest {
    ...
    private GetDriverTachographActivityRequest(
    ...
    /**
     * @return An end time in RFC 3339 format. It can't be more than 30 days past startTime. Millisecond precision and timezones are supported. (Examples: 2019-06-13T19:08:25Z, 2019-06-13T19:08:25.455Z, OR 2015-09-15T14:00:12-04:00).
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetDriverTachographActivityRequest
                && equalTo((GetDriverTachographActivityRequest) other);
    }
    ...
    private boolean equalTo(GetDriverTachographActivityRequest other) {
    ...
    public interface StartTimeStage {
        ...
        Builder from(GetDriverTachographActivityRequest other);
    }

    public interface EndTimeStage {
        /**
         * <p>An end time in RFC 3339 format. It can't be more than 30 days past startTime. Millisecond precision and timezones are supported. (Examples: 2019-06-13T19:08:25Z, 2019-06-13T19:08:25.455Z, OR 2015-09-15T14:00:12-04:00).</p>
         */
        _FinalStage endTime(@NotNull String endTime);
    }

    public interface _FinalStage {
        GetDriverTachographActivityRequest build();
    ...
    public static final class Builder implements StartTimeStage, EndTimeStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(GetDriverTachographActivityRequest other) {
        ...
        @java.lang.Override
        public GetDriverTachographActivityRequest build() {
            return new GetDriverTachographActivityRequest(

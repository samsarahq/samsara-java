...
public final class MediaRetrievalPostMediaRetrievalRequestBodyMediaType {
    ...
    MediaRetrievalPostMediaRetrievalRequestBodyMediaType(Value value, String string) {
        this.value = value;
        this.string = string;
    }
    ...
    public boolean equals(Object other) {
        return (this == other)
                || (other instanceof MediaRetrievalPostMediaRetrievalRequestBodyMediaType
                        && this.string.equals(((MediaRetrievalPostMediaRetrievalRequestBodyMediaType) other).string));
    }
    ...
    public static MediaRetrievalPostMediaRetrievalRequestBodyMediaType valueOf(String value) {
        switch (value) {
            case "videoHighRes":
            ...
            case "image":
                return IMAGE;
            default:
                return new MediaRetrievalPostMediaRetrievalRequestBodyMediaType(Value.UNKNOWN, value);
        }
    }

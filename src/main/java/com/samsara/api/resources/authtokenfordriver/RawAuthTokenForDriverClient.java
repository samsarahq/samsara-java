...
public class RawAuthTokenForDriverClient {
    protected final ClientOptions clientOptions;

    public RawAuthTokenForDriverClient(ClientOptions clientOptions) {
     ...
     */
    public SamsaraApiHttpResponse<AuthTokenAuthTokenResponseBody> authToken(AuthTokenAuthTokenRequestBody request) {
        return authToken(request, null);
    }
     ...
     * <p><strong>Submit Feedback</strong>: Likes, dislikes, and API feature requests should be filed as feedback in our &lt;a href=&quot;https://forms.gle/zkD4NCH7HjKb7mm69&quot; target=&quot;_blank&quot;&gt;API feedback form&lt;/a&gt;. If you encountered an issue or noticed inaccuracies in the API documentation, please &lt;a href=&quot;https://www.samsara.com/help&quot; target=&quot;_blank&quot;&gt;submit a case&lt;/a&gt; to our support team.</p>
     */
    public SamsaraApiHttpResponse<AuthTokenAuthTokenResponseBody> authToken(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SamsaraApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, AuthTokenAuthTokenResponseBody.class),
                        response);
            }
            try {

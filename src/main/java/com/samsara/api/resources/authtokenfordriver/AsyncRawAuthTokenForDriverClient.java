...
public class AsyncRawAuthTokenForDriverClient {
    protected final ClientOptions clientOptions;

    public AsyncRawAuthTokenForDriverClient(ClientOptions clientOptions) {
    ...
    public CompletableFuture<SamsaraApiHttpResponse<AuthTokenAuthTokenResponseBody>> authToken(
        ...
        CompletableFuture<SamsaraApiHttpResponse<AuthTokenAuthTokenResponseBody>> future = new CompletableFuture<>();
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SamsaraApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString, AuthTokenAuthTokenResponseBody.class),
                                response));
                        return;
                    }
                    try {

...
public class AsyncRawDriversClient {
     ...
     */
    public CompletableFuture<SamsaraApiHttpResponse<SyncPagingIterable<Driver>>> list() {
     ...
     * <p>To use this endpoint, select <strong>Read Drivers</strong> under the Drivers category when creating or editing an API token. <a href="/docs/authentication#scopes-for-api-tokens">Learn More.</a></p>
     */
    public CompletableFuture<SamsaraApiHttpResponse<SyncPagingIterable<Driver>>> list(RequestOptions requestOptions) {
     ...
     * <p>To use this endpoint, select <strong>Read Drivers</strong> under the Drivers category when creating or editing an API token. <a href="/docs/authentication#scopes-for-api-tokens">Learn More.</a></p>
     */
    public CompletableFuture<SamsaraApiHttpResponse<SyncPagingIterable<Driver>>> list(ListDriversRequest request) {
    ...
    public CompletableFuture<SamsaraApiHttpResponse<SyncPagingIterable<Driver>>> list(
        ...
        CompletableFuture<SamsaraApiHttpResponse<SyncPagingIterable<Driver>>> future = new CompletableFuture<>();
     ...
     */
    public CompletableFuture<SamsaraApiHttpResponse<DriverResponse>> create(CreateDriverRequest request) {
     ...
     * <p>To use this endpoint, select <strong>Write Drivers</strong> under the Drivers category when creating or editing an API token. <a href="/docs/authentication#scopes-for-api-tokens">Learn More.</a></p>
     */
    public CompletableFuture<SamsaraApiHttpResponse<DriverResponse>> create(
            CreateDriverRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("fleet/drivers");
        if (requestOptions != null) {
        ...
        CompletableFuture<SamsaraApiHttpResponse<DriverResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SamsaraApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBodyString, DriverResponse.class),
                                response));
                        return;
                    }
                    Object errorBody = ObjectMappers.parseErrorBody(responseBodyString);
     ...
     * <p>To use this endpoint, select <strong>Write Driver Remote Signout</strong> under the Drivers category when creating or editing an API token. <a href="/docs/authentication#scopes-for-api-tokens">Learn More.</a></p>
     * <p><strong>Submit Feedback</strong>: Likes, dislikes, and API feature requests should be filed as feedback in our &lt;a href=&quot;https://forms.gle/zkD4NCH7HjKb7mm69&quot; target=&quot;_blank&quot;&gt;API feedback form&lt;/a&gt;. If you encountered an issue or noticed inaccuracies in the API documentation, please &lt;a href=&quot;https://www.samsara.com/help&quot; target=&quot;_blank&quot;&gt;submit a case&lt;/a&gt; to our support team.</p>
     */
    public CompletableFuture<SamsaraApiHttpResponse<DriverRemoteSignoutPostDriverRemoteSignoutResponseBody>>
            postDriverRemoteSignout(DriverRemoteSignoutPostDriverRemoteSignoutRequestBody request) {
    ...
    public CompletableFuture<SamsaraApiHttpResponse<DriverRemoteSignoutPostDriverRemoteSignoutResponseBody>>
        ...
        CompletableFuture<SamsaraApiHttpResponse<DriverRemoteSignoutPostDriverRemoteSignoutResponseBody>> future =
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new SamsaraApiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBodyString,
                                        DriverRemoteSignoutPostDriverRemoteSignoutResponseBody.class),
                                response));
                        return;
                    }
                    try {
     ...
     * <p>To use this endpoint, select <strong>Write Drivers</strong> under the Drivers category when creating or editing an API token. <a href="/docs/authentication#scopes-for-api-tokens">Learn More.</a></p>
     */
    public CompletableFuture<SamsaraApiHttpResponse<DriverResponse>> update(String id) {
     ...
     * <p>To use this endpoint, select <strong>Write Drivers</strong> under the Drivers category when creating or editing an API token. <a href="/docs/authentication#scopes-for-api-tokens">Learn More.</a></p>
     */
    public CompletableFuture<SamsaraApiHttpResponse<DriverResponse>> update(String id, RequestOptions requestOptions) {
     ...
     * <p>To use this endpoint, select <strong>Write Drivers</strong> under the Drivers category when creating or editing an API token. <a href="/docs/authentication#scopes-for-api-tokens">Learn More.</a></p>
     */
    public CompletableFuture<SamsaraApiHttpResponse<DriverResponse>> update(String id, UpdateDriverRequest request) {
     ...
     * <p>To use this endpoint, select <strong>Write Drivers</strong> under the Drivers category when creating or editing an API token. <a href="/docs/authentication#scopes-for-api-tokens">Learn More.</a></p>
     */
    public CompletableFuture<SamsaraApiHttpResponse<DriverResponse>> update(

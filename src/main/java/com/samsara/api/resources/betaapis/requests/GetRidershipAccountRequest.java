...
@JsonDeserialize(builder = GetRidershipAccountRequest.Builder.class)
public final class GetRidershipAccountRequest {
    private final Optional<Boolean> includeExternalIds;

    private final Map<String, Object> additionalProperties;

    private GetRidershipAccountRequest(Optional<Boolean> includeExternalIds, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetRidershipAccountRequest && equalTo((GetRidershipAccountRequest) other);
    }
    ...
    private boolean equalTo(GetRidershipAccountRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetRidershipAccountRequest other) {
        ...
        public GetRidershipAccountRequest build() {
            return new GetRidershipAccountRequest(includeExternalIds, additionalProperties);
        }
    }
}

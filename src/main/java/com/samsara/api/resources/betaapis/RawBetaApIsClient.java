...
public class RawBetaApIsClient {
     ...
     * <p><strong>Submit Feedback</strong>: Likes, dislikes, and API feature requests should be filed as feedback in our <a href="https://forms.gle/zkD4NCH7HjKb7mm69" target="_blank">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href="https://www.samsara.com/help" target="_blank">submit a case</a> to our support team.</p>
     */
    public SamsaraApiHttpResponse<EntityGroundIntelligenceIssuesServiceListIssuesResponseBody> listIssues() {
        return listIssues(ListIssuesRequest.builder().build());
    }
    ...
    public SamsaraApiHttpResponse<EntityGroundIntelligenceIssuesServiceListIssuesResponseBody> listIssues(
            RequestOptions requestOptions) {
        return listIssues(ListIssuesRequest.builder().build(), requestOptions);
    }
    ...
    public SamsaraApiHttpResponse<EntityGroundIntelligenceIssuesServiceListIssuesResponseBody> listIssues(
        ...
        return listIssues(request, null);
    }
    ...
    public SamsaraApiHttpResponse<EntityGroundIntelligenceIssuesServiceListIssuesResponseBody> listIssues(
        ...
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("ground-intelligence/issues");
        if (request.getIds().isPresent()) {
        ...
        if (request.getStatuses().isPresent()) {
            QueryStringMapper.addQueryParameter(
                    httpUrl, "statuses", request.getStatuses().get(), false);
        }
        if (request.getSeverities().isPresent()) {
            QueryStringMapper.addQueryParameter(
                    httpUrl, "severities", request.getSeverities().get(), false);
        }
        if (request.getEndTime().isPresent()) {
            QueryStringMapper.addQueryParameter(
                    httpUrl, "endTime", request.getEndTime().get(), false);
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SamsaraApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(
                                responseBodyString, EntityGroundIntelligenceIssuesServiceListIssuesResponseBody.class),
                        response);
            }
            try {
                switch (response.code()) {
     ...
     * <p><strong>Submit Feedback</strong>: Likes, dislikes, and API feature requests should be filed as feedback in our <a href="https://forms.gle/zkD4NCH7HjKb7mm69" target="_blank">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href="https://www.samsara.com/help" target="_blank">submit a case</a> to our support team.</p>
     */
    public SamsaraApiHttpResponse<EntityGroundIntelligenceIssuesServiceUpdateGroundIntelligenceIssueResponseBody>
            updateGroundIntelligenceIssue(
                    EntityGroundIntelligenceIssuesServiceUpdateGroundIntelligenceIssueRequestBody request) {
        return updateGroundIntelligenceIssue(request, null);
    }
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new SamsaraApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(
                                responseBodyString,
                                EntityGroundIntelligenceIssuesServiceUpdateGroundIntelligenceIssueResponseBody.class),
                        response);
            }
            try {
                switch (response.code()) {
     ...
     * <p><strong>Submit Feedback</strong>: Likes, dislikes, and API feature requests should be filed as feedback in our <a href="https://forms.gle/zkD4NCH7HjKb7mm69" target="_blank">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href="https://www.samsara.com/help" target="_blank">submit a case</a> to our support team.</p>
     */
    public SamsaraApiHttpResponse<EntityInventoryTransactionsServiceListPartTransactionsResponseBody>

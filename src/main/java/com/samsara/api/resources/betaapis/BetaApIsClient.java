...
public class BetaApIsClient {
     ...
     * <p><strong>Submit Feedback</strong>: Likes, dislikes, and API feature requests should be filed as feedback in our <a href="https://forms.gle/zkD4NCH7HjKb7mm69" target="_blank">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href="https://www.samsara.com/help" target="_blank">submit a case</a> to our support team.</p>
     */
    public EntityGroundIntelligenceIssuesServiceListIssuesResponseBody listIssues() {
        return this.rawClient.listIssues().body();
    }
     ...
     * <p><strong>Submit Feedback</strong>: Likes, dislikes, and API feature requests should be filed as feedback in our <a href="https://forms.gle/zkD4NCH7HjKb7mm69" target="_blank">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href="https://www.samsara.com/help" target="_blank">submit a case</a> to our support team.</p>
     */
    public EntityGroundIntelligenceIssuesServiceListIssuesResponseBody listIssues(RequestOptions requestOptions) {
        return this.rawClient.listIssues(requestOptions).body();
    }
     ...
     * <p><strong>Submit Feedback</strong>: Likes, dislikes, and API feature requests should be filed as feedback in our <a href="https://forms.gle/zkD4NCH7HjKb7mm69" target="_blank">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href="https://www.samsara.com/help" target="_blank">submit a case</a> to our support team.</p>
     */
    public EntityGroundIntelligenceIssuesServiceListIssuesResponseBody listIssues(ListIssuesRequest request) {
        return this.rawClient.listIssues(request).body();
    }
    ...
    public EntityGroundIntelligenceIssuesServiceListIssuesResponseBody listIssues(
        ...
        return this.rawClient.listIssues(request, requestOptions).body();
    }
     ...
     * <p><strong>Submit Feedback</strong>: Likes, dislikes, and API feature requests should be filed as feedback in our <a href="https://forms.gle/zkD4NCH7HjKb7mm69" target="_blank">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href="https://www.samsara.com/help" target="_blank">submit a case</a> to our support team.</p>
     */
    public EntityGroundIntelligenceIssuesServiceUpdateGroundIntelligenceIssueResponseBody updateGroundIntelligenceIssue(
            EntityGroundIntelligenceIssuesServiceUpdateGroundIntelligenceIssueRequestBody request) {
        return this.rawClient.updateGroundIntelligenceIssue(request).body();
    }

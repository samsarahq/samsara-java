...
@JsonDeserialize(builder = GetRidershipPassengerRequest.Builder.class)
public final class GetRidershipPassengerRequest {
    private final Optional<Boolean> includeExternalIds;

    private final Map<String, Object> additionalProperties;

    private GetRidershipPassengerRequest(
            Optional<Boolean> includeExternalIds, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetRidershipPassengerRequest && equalTo((GetRidershipPassengerRequest) other);
    }
    ...
    private boolean equalTo(GetRidershipPassengerRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetRidershipPassengerRequest other) {
        ...
        public GetRidershipPassengerRequest build() {
            return new GetRidershipPassengerRequest(includeExternalIds, additionalProperties);
        }
    }
}

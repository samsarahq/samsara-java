...
@JsonDeserialize(builder = GetReportConfigsRequest.Builder.class)
public final class GetReportConfigsRequest {
    ...
    private GetReportConfigsRequest(
    ...
    /**
     * @return The list of report config IDs to retrieve. Include up to 10 report config IDs. If not provided, all configs will be returned.
     */
    @JsonProperty("ids")
    ...
    /**
     * @return Maximum number of configs to return
     */
    @JsonProperty("limit")
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetReportConfigsRequest && equalTo((GetReportConfigsRequest) other);
    }
    ...
    private boolean equalTo(GetReportConfigsRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetReportConfigsRequest other) {
            ids(other.getIds());
        ...
        /**
         * <p>The list of report config IDs to retrieve. Include up to 10 report config IDs. If not provided, all configs will be returned.</p>
         */
        ...
        /**
         * <p>Maximum number of configs to return</p>
         */
        ...
        public GetReportConfigsRequest build() {
            return new GetReportConfigsRequest(ids, after, limit, additionalProperties);
        }
    }
}

...
@JsonDeserialize(builder = ListVendorCategoriesRequest.Builder.class)
public final class ListVendorCategoriesRequest {
    private final Optional<String> after;

    private final Map<String, Object> additionalProperties;

    private ListVendorCategoriesRequest(Optional<String> after, Map<String, Object> additionalProperties) {
        this.after = after;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListVendorCategoriesRequest && equalTo((ListVendorCategoriesRequest) other);
    }
    ...
    private boolean equalTo(ListVendorCategoriesRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListVendorCategoriesRequest other) {
        ...
        public ListVendorCategoriesRequest build() {
            return new ListVendorCategoriesRequest(after, additionalProperties);
        }
    }
}

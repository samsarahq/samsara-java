...
@JsonDeserialize(builder = GetDvirRequest.Builder.class)
public final class GetDvirRequest {
    private final Optional<Boolean> includeExternalIds;

    private final Map<String, Object> additionalProperties;

    private GetDvirRequest(Optional<Boolean> includeExternalIds, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetDvirRequest && equalTo((GetDvirRequest) other);
    }
    ...
    private boolean equalTo(GetDvirRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GetDvirRequest other) {
        ...
        public GetDvirRequest build() {
            return new GetDvirRequest(includeExternalIds, additionalProperties);
        }
    }
}

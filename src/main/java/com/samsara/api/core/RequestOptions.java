...
public final class RequestOptions {
    ...
    /**
     * version.get().toString() is sent as the "X-Samsara-Version" header, overriding client options if present.
     */
    ...
    public Map<String, String> getHeaders() {
        ...
        if (this.version.isPresent()) {
            headers.put("X-Samsara-Version", this.version.get().toString());
        }
        if (this.token != null) {

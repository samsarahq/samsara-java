...
public final class ClientOptions {
    ...
    /**
     * version.toString() is sent as the "X-Samsara-Version" header.
     */
    private final ApiVersion version;

    /**
     * @param version Defaults to "2025-06-11" if empty
     */
    private ClientOptions(
        ...
        this.headers.putAll(new HashMap<String, String>() {
            {
                put("User-Agent", "com.samsara:samsara-java-sdk/13.19.0");
                put("X-Fern-Language", "JAVA");
                put("X-Fern-SDK-Name", "com.samsara.fern:api-sdk");
                put("X-Fern-SDK-Version", "13.19.0");
            }
        });
        ...
        this.version = version.orElse(ApiVersion._20250611);
        this.headers.put("X-Samsara-Version", this.version.toString());
    }
    ...
    public static class Builder {
        ...
        public static Builder from(ClientOptions clientOptions) {
            ...
            if (clientOptions.version != null) {
                ...
                builder.version = Optional.of(ApiVersion._20250611);
            }
            return builder;
        }
    }
